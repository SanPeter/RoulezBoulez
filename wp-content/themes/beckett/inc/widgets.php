...
class TTrust_Recent_Posts extends WP_Widget {
	...
	function TTrust_Recent_Posts() {
		...
		$widget_ops = array('classname' => 'ttrust_recent_posts', 'description' => __('Display recent posts from any category.', 'beckett'));
		$this->WP_Widget('ttrust_recent_posts', $ttrust_theme_name.' '.__('Recent Posts', 'beckett'), $widget_ops);
	}
...
<?php
	...
	function form( $instance ) {
		...
		<p><label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:', 'beckett'); ?></label>
		<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" /></p>
		<p><label for="<?php echo $this->get_field_id('rp_cat'); ?>"><?php _e('Category', 'beckett'); ?></label>
		<select class="widefat" id="<?php echo $this->get_field_id('rp_cat'); ?>" name="<?php echo $this->get_field_name('rp_cat'); ?>">
			<option value=""><?php _e('All', 'beckett'); ?></option>
		...
		<p><label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Number of posts:', 'beckett'); ?></label>
		<input id="<?php echo $this->get_field_id('number'); ?>" name="<?php echo $this->get_field_name('number'); ?>" type="text" value="<?php echo $number; ?>" size="3" /><br />
		<small><?php _e('10 max', 'beckett'); ?></small></p>
<?php
	}
}
...
class TTrust_Flickr extends WP_Widget {
	...
	function TTrust_Flickr() {
		...
		$this->WP_Widget('ttrust_flickr', $ttrust_theme_name.' '.__('Flickr', 'beckett'), $widget_ops);
...
?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:', 'beckett'); ?>
			<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
			</label>
		</p>

		<p>
			<label for="<?php echo $this->get_field_id('user'); ?>"><?php _e('Flickr ID:', 'beckett'); ?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('flickr_nr'); ?>"><?php _e('Number of photos:', 'beckett'); ?></label>
...
class TTrust_Testimonials extends WP_Widget {
	...
	function TTrust_Testimonials() {
		global $ttrust_theme_name, $ttrust_version, $options;
		$widget_ops = array('classname' => 'beckett-testimonials', 'description' => __('Display a random testimonial.', 'themetrust'));
		$this->WP_Widget('ttrust_testimonials', $ttrust_theme_name.' '.__('Testimonials', 'themetrust'), $widget_ops);
	}
...
?>				
			...
			<?php echo $before_title . $title . $after_title; ?>			
				...
				<?php  while ($r->have_posts()) : $r->the_post(); ?>
					<div class="clearfix">								
						<?php the_post_thumbnail("beckett_post_thumb_small", array('class' => '', 'alt' => ''.the_title_attribute( 'echo=0' ).'', 'title' => ''.the_title_attribute( 'echo=0' ).'')); ?>						
						<?php the_content(); ?>	
...
class TTrust_Service extends WP_Widget {
	...
	function TTrust_Service() {
		global $ttrust_theme_name, $ttrust_version, $options;
		$widget_ops = array('description' => __('Highlight a service with text and an icon.', 'themetrust'));
		$this->WP_Widget('ttrust_Service', $ttrust_theme_name.' '.__('Service', 'themetrust'), $widget_ops);
	}
